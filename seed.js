...
async function cargarDatos() {
    // force: true limpia y recrea las tablas (usar solo en desarrollo)
    ...
    // Relacionar películas con sus respectivos elencos
    await inception.addActors([actor1, actor3]);
    await titanic.addActors([actor1, actor2]);
    
    console.log('¡Base de datos e información inicial cargadas con éxito!');
}
